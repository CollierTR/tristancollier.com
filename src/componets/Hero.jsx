  ...
  return (
    <div className="flex justify-center items-center lg:gap-x-20 my-20 flex-col lg:flex-row">
      <div className=" w-10/12 lg:w-5/12 flex flex-col md:gap-6 lg:gap-12 gap-4 place-items-center md:place-items-start">
        <h1 className="md:text-left text-center text-3xl sm:text-3xl md:text-5xl lg:text-6xl lg:whitespace-nowrap text-pretty relative z-10 text-light-primary my-shadow rob">
          Take your business to the next level!
        </h1>

        <p className="sm:text-lg lg:text-2xl md:text-start text-center">
